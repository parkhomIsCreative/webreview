...
import com.example.webrewiew.facade.PostFacade;
import com.example.webrewiew.payload.response.MessageResponse;
import com.example.webrewiew.service.PostService;
...
public class PostController  {
    ...
    @PostMapping("/create")
    public ResponseEntity<Object> createPost(@Valid @RequestBody PostDTO postDTO, Principal principal){
    ...
    public ResponseEntity<PostDTO> postLike(@PathVariable String postId,
    ...
    public ResponseEntity<MessageResponse> postDelete(@PathVariable String postId, Principal principal){
